...
odt_facing_capacity_constraint = np.load('output/pickle/odt_facing_disruption_alns.pkl', allow_pickle=True)
timetable_initial_graph = np.load('output/pickle/timetable_alns.pkl', allow_pickle=True)
odt_facing_disruption = np.load('output/pickle/odt_facing_disruption_alns.pkl', allow_pickle=True)
parameters = np.load('output/pickle/parameters_alns.pkl', allow_pickle=True)
odt_facing_capacity_dict_for_iteration =\
    np.load('output/pickle/odt_facing_capacity_dict_facing_capacity_constraint_alns.pkl', allow_pickle=True)
